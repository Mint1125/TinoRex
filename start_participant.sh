#!/bin/bash
# Start AgentX services inside a single container for AgentBeats submission.
# NOTE: Evaluator is provided by the platform — only solver + arena are started here.
